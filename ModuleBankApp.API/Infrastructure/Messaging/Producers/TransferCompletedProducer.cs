...
public class TransferCompletedProducer(IEventBusService eventBusService,
                                   ILogger<TransferCompletedProducer> logger,
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            var publishEvents = await db.Outbox
                .Where(e => e.Status == OutboxStatus.Pending && e.Type == nameof(TransferCompleted))
            ...
            foreach (var @event in publishEvents)
            {
                ...
                try
                {
                    await Policy
                        ...
                        .ExecuteAsync(() => eventBusService.PublishAsync(@event, routekey: "money.transfer.completed", stoppingToken));
