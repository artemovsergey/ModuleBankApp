...
public class InterestAccruedProducer(IEventBusService eventBusService,
                                   ILogger<InterestAccruedProducer> logger,
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            var publishEvents = await db.Outbox
                .Where(e => e.Status == OutboxStatus.Pending && e.Type == nameof(InterestAccrued))
            ...
            foreach (var @event in publishEvents)
            {
                ...
                try
                {
                    await Policy
                        ...
                        .ExecuteAsync(() => eventBusService.PublishAsync(@event, routekey: "account.interest.accrued", stoppingToken));
